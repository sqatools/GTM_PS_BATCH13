...
class ABC:
    ...
    def addition(self):
        print("Addition: ", self.n1val + self.n2val)

    def multiplication(self, v1, v2, v3):
        print("Multipication from class ABC: ", v1 * v2 * v3)
...
class XYZ(ABC):
    ...
    # therefore method overloading not supported in python
...
#It will show you the method and attributes
print(dir(XYZ))
