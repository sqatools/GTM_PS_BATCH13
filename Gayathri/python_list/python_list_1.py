...
#2. Reverse the numbers from 15- 5
print(list3[-5:-10:-1]) #[15, 2, 9, 8, 5]
#3.get only these characters - 'a', 'p', 'q', 'b'
print(list3[5:]) #['a', 'p', 'q', 'b']
...
print("_" * 50)
#here we cant modify the existing string value as string data type is immutable
