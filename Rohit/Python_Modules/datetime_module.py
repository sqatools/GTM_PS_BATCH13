...
from Deepesh.PythonProgramming.Python_Modules.datetime_module import current_date

current_time = datetime.now()
print(current_time) # 2025-11-11 08:10:13.191096
print("current date :",current_date.date()) # 2025-11-11
print("current particular date :",current_date.day) # 11
...
######### Get date 2 date Ago #####
print("2 days ago date :",current_date-timedelta(days=2)) # 2025-11-09 08:22:12.627689
print("Display 2 days ago date :", (current_date-timedelta(days=3)).date()) # 2025-11-08

print("2 days after date :", current_date+timedelta(days=2)) # 2025-11-13 08:25:21.726177
print("Display 2 days after date :", (current_date+timedelta(days=3)).date()) # 2025-11-14
