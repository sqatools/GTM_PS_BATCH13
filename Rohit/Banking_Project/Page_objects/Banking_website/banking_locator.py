...
Delete_branch = (By.XPATH,"//tr[td[text()='5164']]//img[@src='images/delete.png']")

# update Branch
update_Branch_submenu_btn = (By.XPATH,"//a[normalize-space()='Update Branches']")
update_branch_button = (By.XPATH,"//tr[td[text()='5193']]//img[@src='images/edit.png']")
...
Delete_Employee_details_btn = (By.XPATH,"//tr[td[text()='5592']]//input[@value='Delete']")
...
update_btn= (By.XPATH,"//tr[td[text()='5593']]//input[@type='submit']")
