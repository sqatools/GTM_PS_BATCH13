...
class TestBankingWebsite:
    ...
    def test_Customer_Register_functionality(self):
        ...
        time.sleep(3)
        self.bw.enter_Username(RegistrationLoc.Username_field,"Mahesh89")
    ...
    def test_Funds_Transfer_functionality(self):
           ...
           time.sleep(3)
           self.bw.select_Funds_From_account("14343")
           time.sleep(3)
           self.bw.select_Funds_to_account("14565")
           time.sleep(3)
    ...
    def test_Bill_Payement_Service_functionality(self):
           ...
           self.bw.enter_Bill_Account(Bill_Account,"14343")
           self.bw.enter_Bill_Verify_Account(Verify_Account,"14343")
           self.bw.enter_Bill_Amount(Bill_Amount,"50")
           time.sleep(5)
           self.bw.enter_Bill_From_account(Bill_From_account,"14565")
           time.sleep(3)
    ...
    def test_find_transaction_functioanlity(self):
           ...
           self.bw.select_transaction_account(Select_an_account,"14343")
           time.sleep(3)
           ...
           self.bw.enter_to_transaction_date(Find_by_to_Date_Range,"12-22-2025")
           time.sleep(3)
    ...
    def test_Request_Loan_functioanlity(self):
           ...
           self.bw.enter_requestloan_from_account(Requestloan_From_account,"13455")
