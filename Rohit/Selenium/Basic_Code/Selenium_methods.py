...
print("radion button is displayed :", radio_btn.is_displayed())
...
print("Link url :", login_link.get_attribute('href'))

# Forward, Back, Refresh.
login_link.click()
time.sleep(2)
driver.save_screenshot(r"D:\Python Class\Screen_shot\login_page_image1.png")

# back to dummy page
driver.back()
time.sleep(2)
driver.save_screenshot(r"D:\Python Class\Screen_shot\dummy_page_image2.png")

# move forward to login
driver.forward()
time.sleep(2)
driver.save_screenshot(r"D:\Python Class\Screen_shot\login_page_image3.png")
