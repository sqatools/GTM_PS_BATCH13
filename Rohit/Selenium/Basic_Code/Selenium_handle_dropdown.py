...
#select_by_visible_text_label("United Kingdom")
...
def select_by_index_posittion(index_value):
    dropdown = driver.find_element(By.ID, "billing_country")
    select_obj = Select(dropdown)
    select_obj.select_by_index(index_value)
    time.sleep(10)

#select_by_index_posittion(3)
...
def locate_element_with_dynamic_dropdown():
    ...
    dropdown_parent = driver.find_element(By.XPATH, "//div[@id='autocomplete-results']//ul")
    dropdown_parent.find_element(By.XPATH, "//*[text()='Pune']").click()
    time.sleep(10)
